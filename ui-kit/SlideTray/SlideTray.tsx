...
const SlideTray = forwardRef<unknown, SlideTrayProps>(
  (
    {
      triggerComponent,
      title,
    ...
    const calculateDismissThreshold = () => {
      if (trayRef.current) {
        const threshold =
          trayRef.current.clientHeight * dismissThresholdPercentage;
          ...
          >
            <div className="relative flex flex-col h-full">
              {title && (
                <Fragment>
                  <h2
                    className={`text-h5 font-bold line-clamp-1 ${titleColor} text-center mb-2`}
                  >
                    {title}
                  </h2>
                ...
                <Fragment>
                  ...
                  <div className="flex justify-center mt-1">
                    <DialogPrimitive.Close asChild>
                      <Button className="w-[56%] py-3 rounded-full text-lg">
                        Close
                      </Button>
                    </DialogPrimitive.Close>
                  </div>
...
SlideTray.displayName = 'SlideTray';
export { SlideTray };
